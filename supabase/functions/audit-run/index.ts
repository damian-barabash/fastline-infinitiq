...
// ======================= KATALOG PRODUKTÓW FIQ (17 produktów, 4 grupy, 09.2026) =======================
// Źródłem prawdy jest tabela audit_catalog (edytor /katalog); poniższa lista to tylko awaryjny fallback.
...
const CATALOG_FALLBACK: Product[] = [
  { id: 1, name: "Fabryka Kontentu", group: "Marketing i treści", sense: "Mind",
  ...
  { id: 2, name: "SEO & GEO Autopilot", group: "Marketing i treści", sense: "Mind",
  ...
  { id: 3, name: "AI Reputation Guard", group: "Marketing i treści", sense: "Eyes",
  ...
  { id: 5, name: "AI CRM", group: "Sprzedaż", sense: "Eyes",
  ...
  { id: 6, name: "AI Generator Ofert", group: "Sprzedaż", sense: "Hand",
  ...
  { id: 7, name: "Loyalty Engine", group: "Sprzedaż", sense: "Heart",
  ...
  { id: 8, name: "AI Sprzedawca", group: "Agenci i obsługa klienta", sense: "Brain",
    tagline: "Pierwsza linia sprzedaży: łapie zapytanie w sekundę i domyka.",
    does: ["Odpowiada w kilka sekund na czacie, w social, na WhatsAppie i mailem — o każdej porze.", "Prowadzi rozmowę do zamknięcia: kwalifikuje, podaje cenę, wysyła link do zakupu.", "Umawia spotkanie i oddaje rozmowę człowiekowi, gdy klient o to prosi.", "Uczy się na poprawkach trenera — każda uwaga wchodzi od razu do wszystkich rozmów."],
    problem: "zapytania przychodzą wieczorem i w weekend, a odpowiedź idzie następnego dnia — klient w tym czasie pisze do konkurencji.",
    effect: "każde zapytanie dostaje odpowiedź od razu, a rozmowa kończy się zamówieniem albo umówionym spotkaniem.", impl: 3000, sub: 1500 },
  { id: 9, name: "AI Doradca", group: "Agenci i obsługa klienta", sense: "Brain",
    tagline: "Tłumaczy ofertę na język decyzji i prowadzi klienta do zakupu.",
    does: ["Dobiera wariant do realnych potrzeb, a nie do cennika.", "Rozbraja wątpliwości: cena, termin, gwarancja, porównanie z konkurencją.", "Zna całą ofertę i bazę wiedzy — odpowiada tak samo dobrze o każdej porze.", "Przy przejęciu oddaje człowiekowi gotowy kontekst rozmowy."],
    problem: "klient nie wie, który wariant wybrać, więc odkłada decyzję — a im dłużej zwleka, tym rzadziej wraca.",
    effect: "klient dostaje konkretną rekomendację zamiast katalogu i kupuje szybciej, bez czekania na handlowca.", impl: 3000, sub: 1500 },
  { id: 10, name: "AI Recepcja 24/7", group: "Agenci i obsługa klienta", sense: "Heart",
  ...
  { id: 11, name: "AI Data Hub", group: "Operacje i zarządzanie", sense: "Brain",
  ...
  { id: 12, name: "Inteligentny Magazyn", group: "Operacje i zarządzanie", sense: "Hand",
  ...
  { id: 13, name: "Market Radar", group: "Operacje i zarządzanie", sense: "Eyes",
  ...
  { id: 14, name: "AI Project Manager", group: "Operacje i zarządzanie", sense: "Hand",
  ...
  { id: 15, name: "AI Asystent", group: "Operacje i zarządzanie", sense: "Brain",
    tagline: "Pamięć operacyjna firmy: zespół pyta, asystent odpowiada.",
    does: ["Odpowiada zespołowi z wewnętrznej bazy wiedzy: procedury, oferta, ceny, ustalenia.", "Podaje źródło odpowiedzi, żeby dało się ją zweryfikować.", "Wchłania nowe dokumenty i strony bez przepisywania ich ręcznie.", "Działa w panelu i w kanałach, z których zespół już korzysta."],
    problem: "wiedza siedzi w głowach i w dziesięciu folderach, więc te same pytania wracają, a nowa osoba wdraża się tygodniami.",
    effect: "odpowiedź z firmowej bazy wiedzy w kilka sekund, bez zawracania głowy współpracownikom.", impl: 2500, sub: 1200 },
  { id: 16, name: "Rekruter AI", group: "Operacje i zarządzanie", sense: "Heart",
  ...
  { id: 17, name: "AI Academy", group: "Operacje i zarządzanie", sense: "Brain",
...
Zasady: id = numer z katalogu (liczba); tier: 1 = Start (najpilniejsze), 2 = Wzrost, 3 = Skala — rozłóż wybrane produkty na trzy tiery tak, żeby każdy miał co najmniej 2 (im pilniejszy problem, tym niższy tier). Produkt od widoczności w Google i AI (SEO & GEO Autopilot) MUSI być wśród 6 — to audyt widoczności, zwykle tier 1. Nie wybieraj produktów bez uzasadnienia w faktach ze strony klienta: Inteligentny Magazyn tylko dla firm z towarem/magazynem; AI Recepcja 24/7 tylko gdy telefon albo wizyty są kanałem sprzedaży; Loyalty Engine gdy klienci wracają (gastro, beauty, retail, usługi cykliczne); AI Generator Ofert i AI Łowca Leadów gdy jest sprzedaż z ofertowaniem i pozyskiwaniem leadów; AI CRM gdy jest zespół handlowy i powtarzalne rozmowy; Market Radar gdy klient działa na konkurencyjnym rynku z ruchami cen; Rekruter AI i AI Academy gdy firma rekrutuje albo ma rotację; AI Data Hub i AI Project Manager gdy skala firmy uzasadnia kontrolę liczb i procesów; AI Sprzedawca gdy zapytania przychodzą poza godzinami i nikt nie odpowiada od razu; AI Doradca gdy oferta jest złożona i klient musi wybierać wariant; AI Asystent gdy zespół tonie w powtarzalnych pytaniach o procedury i ofertę. Pisz po polsku, zwięźle.
