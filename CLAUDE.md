...
- Роуты: `/`, `/kontakt`, `/login`, `/editor` (+вкладка Audyt), `/audyt/:slug` (клиентский аудит, noindex). Edge-функция `audit-run` (Barabash AI, ключ `fiq-audit`, qwen3.5:9b, max 2 параллельных вызова — общий gateway с Теосом/CatMon).
